...
extern Sophus::SE3f transform_to_world, transform_cam_to_link;

extern ros::Publisher pose_pub, map_points_pub, marker_pub;
...
void publish_ros_marker(Sophus::SE3f, ros::Time);
